...
tags: tutorial
backLink: true
sourceUrl: "https://docs.google.com/document/d/1w40xcAqGArXUJtNGZ-qhVRSNNJZxXRJnAvy48QxyybU/edit?usp=sharing"
---
<article class="tutorial-content">

<div style="text-align: center; border-bottom: 1px solid var(--border-color); margin-bottom: 30px; padding-bottom: 20px;">
    <h1 style="margin: 0;">🧟 THE GOLDEN ZOMBIE GUIDE 🧟</h1>
...
**The Mindset:**
This event will destroy your troops. Remember that you train troops to fight and die! The Golden Zombie event is a fantastic trade of troops for massive resources. You just need to ensure your drill grounds are fully stocked throughout the event. **Stay chill** about losing troops—the rewards are worth it.
...
- **⚔️ Chain Your Marches:** Hunt in a continuous march. Hit a zombie, and while your squad is still in the field, immediately target the next one. Hit as many as you can before you run out of stamina or your troops need healing.
...
- **⌚️ Timing:** The event starts two hours after server restart, every second Wednesday and continues until server restart at the end of Friday (70 hours). It alternates with the Marshals Challenge.
...
Killing a Boss provides massive loot, and the game heavily rewards teamwork. There are several ways to get paid:
...
5. **😎 Stay chill:** Because of the Finder's Reward, if you spawn a boss and someone else (even outside our alliance) kills it, don't worry. You still get paid! There are plenty of bosses on the map.
