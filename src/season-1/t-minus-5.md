---
layout: base.njk
title: "🧬 T-Minus 5 Days - The RA Virus & Resistance"
description: "Understanding the RA Virus, permanent resistance, the infection loop, and curing allies."
emoji: "🧬"
date: 2026-05-03
---
...
<div style="text-align: center; border-bottom: 1px solid var(--border-color); margin-bottom: 30px; padding-bottom: 20px;">
    <h1 style="margin: 0; color: #b3002d;">🧬 T-MINUS 5 DAYS: THE RA VIRUS & RESISTANCE 🧬</h1>
...
<span class="season-section-title">1. THE INFECTION BAR & DEBUFFS</span>
...
*   **Combat Penalty**: Drastically reduces your squad's combat damage.
*   **Hospital Pressure**: Causes your troops to randomly become seriously injured and flooded into your hospital.

> 😎 **STAY CHILL**
> Getting infected is inevitable. It is an intentional part of the game design, not a sign that you did something wrong or failed an attack. If your infection bar goes up, do not get upset or panic. We will treat it and keep moving.

---

<span class="season-section-title">2. VIRUS RESISTANCE (YOUR PERMANENT SHIELD)</span>
...
*   **The Damage Check**: Every corrupted target on the map has a specific *Virus Level*. Your Resistance must meet or exceed the target's level. If your Resistance is lower than the target, your troops suffer a massive damage penalty and take heavy infection. If your Resistance is equal to or higher than the target, you fight normally.
*   **Prevention, Not a Cure**: Increasing your permanent Virus Resistance does *not* lower your current infection stacks. It simply acts as a stronger shield, preventing you from getting heavily infected during future attacks on higher-level targets.

---

<span class="season-section-title">3. THE RESISTANCE LOOP & BUILDERS</span>
...
> ⚠️ **VITAL START-OF-SEASON NOTE**
> Step 2 of this loop requires physical builders in your base. Building and upgrading your Protein Farms requires an active builder queue. **Make sure you intentionally start Day 1 of the season with at least one builder completely free** so you can jump straight into the loop.

---

<span class="season-section-title">4. CURING ALLIES (SYRINGES, COORDINATES, & NATURAL DECAY)</span>
...
*   **Natural Decay**: If you stop attacking corrupted targets, your infection bar will slowly drop on its own over time.
