---
layout: base.njk
title: "🗺️ T-Minus 4 Days - Cities, Strongholds, & Expansion"
description: "Understanding territory expansion, the adjacency rule, stronghold captures, and team movement."
emoji: "🗺️"
date: 2026-05-04
---
...
<div style="text-align: center; border-bottom: 1px solid var(--border-color); margin-bottom: 30px; padding-bottom: 20px;">
    <h1 style="margin: 0; color: #009dff;">🗺️ T-MINUS 4 DAYS: CITIES, STRONGHOLDS, & EXPANSION 🗺️</h1>
...
<span class="season-section-title">1. THE DESTINATION vs. THE ROAD</span>
...
<span class="season-section-title">2. THE ADJACENCY RULE & THE SPEED LIMIT</span>
...
<span class="season-section-title">3. EXECUTING THE CAPTURE</span>
...
<span class="season-section-title">4. CATCH AND RELEASE (ABANDONING TERRITORY)</span>
...
*   😎 **Stay Chill:** When you look at the map and see our territory shrinking behind us, do not panic and do not get upset. This is the intended strategy. We can’t keep everything we gain.

---

<span class="season-section-title">5. THE MOVING HIVE</span>
